 ...
 * 
 */
@WebServiceClient(name = "book", targetNamespace = "http://schemas.ericsson.com/vas/", wsdlLocation = "file:/C:/Users/amoee/Desktop/SOAP-CRUD/src/wsdl1/bookService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOK_QNAME = new QName("http://schemas.ericsson.com/vas/", "book");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/amoee/Desktop/SOAP-CRUD/src/wsdl1/bookService.wsdl");
    ...
    public BookServicePortType getBookServicePort() {
        return super.getPort(new QName("http://schemas.ericsson.com/vas/", "BookServicePort"), BookServicePortType.class);
    }
    ...
    public BookServicePortType getBookServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://schemas.ericsson.com/vas/", "BookServicePort"), BookServicePortType.class, features);
    }
